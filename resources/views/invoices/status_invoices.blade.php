        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- ======================= --}}
                    {{-- <form action="{{ isset($invoices) && empty($invoices) ? route('Status_Update', ['id' => $invoices->id]) : '' }}" method="post" autocomplete="off">
    {{ csrf_field() }}
    <!-- محتوى النموذج هنا -->
</form> --}}
                    {{-- ======================= --}}
                    {{-- <form action="{{ isset($invoices) && empty($invoices) ? route('Status_Update', ['id' => $invoices->id]) : '' }}"
