                        ...
                        <div class="dropdown-menu">
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <a href="{{ url('markAsRead') }}"
                                        class="badge badge-pill badge-warning mr-auto my-auto float-left">قرائة كل
                                        الاشعارات</a>
                                </div>
                                ...
                                <span id="notifications_count" class="text-white font-weight-semibold tx-15">
                                    ...
                                    <audio src="{{ asset('assets/audio/3.mp3') }} autoplay">
                                    </audio>
                            ...
                            <div id="unreadNotifications" class="main-notification-list Notification-scroll">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <a class="d-flex p-3 border-bottom notification-link" id="notification-{{ $notification->id }}"
                                        ...
                                        <div class="mr-3">
                                            <span class="notification-label mb-1">
