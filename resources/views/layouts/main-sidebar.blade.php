...
<aside class="app-sidebar sidebar-scroll">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الرئسيه</span></a>
            </li>
            @can('الفواتير')
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @can('الفواتير الغير مدفوعة')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/unpaid')) }}">الفواتير الغير مدفوعه
                            </a></li>
                    @endcan
                    @can('الفواتير المدفوعة جزئيا')
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/partial')) }}">الفواتير المدفوعه
                                جزئيا</a></li>
                    @endcan
                    @can('ارشيف الفواتير')
 ...
 <li class="side-item side-item-category">المحادثه</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon"
                            viewBox="0 0 24 24">
                        ...
                        </svg><span class="side-menu__label">المحادثه</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
